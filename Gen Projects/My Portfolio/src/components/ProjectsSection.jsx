  ...
  return (
    <>
      <header className="relative" id="work">
        <CustomTitle title="Projects" className="mt-44" />
      </header>
      ...
      <article className="relative flex h-full justify-center items-center w-full p-4 mt-32">
            ...
            <AnimatePresence initial={false}>
                {projects.map((project,index) => index === currentIndex && (
                    ...
                    >
                        ...
                        from-primary to-secondary"> {project.title}</h2>
        ...
        <nav>
            <button onClick={nextSlide} className="absolute right-4 z-10 hover:scale-105">
                <img src="https://img.icons8.com/sf-black/100/FFC107/circled-chevron-right.png" alt="circled-chevron-right" width={100} height={100} />
            </button>
        </nav>
      </article>
    </>
